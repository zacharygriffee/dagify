 ...
 * It integrates optional data validation and mapping, and processes incoming
 ...
 * };
 *
 * const cmdNode = new CommandNode("@player/position", handler, { validator, map });
 * // Trigger using set():
...
class CommandNode extends ReactiveNode {
     ...
     * @param {Function} [config.map] - Function that transforms/mapping the data.
     */
