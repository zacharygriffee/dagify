...
class ReactiveNode extends Subject {
    ...
    /**
     * Adds a dependency to this computed node.
     * Subscribes to the dependency so that changes will trigger an update.
     *
     * @param {ReactiveNode} dep - The dependency node to add.
    ...
    /**
     * Removes a dependency from this computed node.
     * Unsubscribes from the dependency and updates the computed value.
     *
     * @param {ReactiveNode} dep - The dependency node to remove.
     * @throws {Error} if this node is not computed.
     */
