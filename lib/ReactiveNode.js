...
class ReactiveNode extends Subject {
    ...
    _setValue(newValue, forceEmit = false) {
        ...
        this.value = newValue;
        // If forceEmit is true or the new value differs from the old value, notify subscribers.
    ...
    removeDependency(...args) {
        ...
        if (Array.isArray(this.normalizedDeps)) {
            ...
            depsToRemove.forEach(dep => {
                ...
                // If not found and dep is a function, search by comparing the underlying function in the computed node.
        ...
        // Named mode: normalizedDeps is an object.
            ...
            if (args.length === 1) {
                ...
                if (typeof arg === 'string') {
                    ...
                    // Iterate and remove based on reference equality.
    ...
    update(fnOrValue) {
        if (this.fn) {
            ...
            if (typeof fnOrValue === 'function') {
                ...
                // If no argument is provided, force a re-emission of the current value.
                this._setValue(this.value, true);
            } else {
                // Otherwise, treat the argument as a new value.
                this.set(fnOrValue);
            }
        }
    }
