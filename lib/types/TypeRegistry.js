...
class TypeRegistry {
     ...
     *
     * @param {string|Function} nameOrValidator - The name of the registered type or the validator function itself.
     * @returns {Function} The validator function.
     */
    getType(nameOrValidator) {
        if (typeof nameOrValidator === "function") return nameOrValidator;
        return this.types.get(nameOrValidator);
    }
